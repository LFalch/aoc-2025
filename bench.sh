...
cd day05
echo "Part 1"
zig build run1 --release=fast -- 707
echo "Part 2"
zig build run2 --release=fast -- 361615643045059
cd ..

echo "Day 6"
cd day06
echo "Part 1"
zig build run1 --release=fast -- 6725216329103
echo "Part 2"
zig build run2 --release=fast -- 10600728112865
cd ..

echo "Day 7"
cd day07
echo "Part 1"
zig build run1 --release=fast -- 1660
echo "Part 2"
zig build run2 --release=fast -- 305999729392659
cd ..
